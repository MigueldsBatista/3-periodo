...
int main(){
    ...
    int *result;
    /*
    newThread é o endereço da struct onde estamos armazenando os valores
    null - 
    myturn - função da thread que vamos executar, deve receber e retornar um ponteiro void
    null - o endereço de onde queremos armazenar o resultado da thread
    */
    yourturn();
